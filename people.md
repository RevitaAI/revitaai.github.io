...
| <span class="image object"> <img style="height: 33vh;" src="assets/images/200133-jue-hou-10.jpg" alt="" /> </span> | [__Jue Hou__](https://researchportal.helsinki.fi/fi/persons/jue-hou) — PhD student.  <br/> Focus: modeling learner proficiency, language modeling with deep-learning neural nets, scalability, educational data science — to analyze data collected from studies with learners.  |
